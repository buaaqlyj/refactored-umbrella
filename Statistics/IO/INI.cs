...
namespace Statistics.IO
{
    ...
    public class INI
    {
        ...
        //
        ////获取文件中所有的节点Section
        //string[] sections = INI.INIGetAllSectionNames(file);

        ////获取指定节点中的所有项value
        //string[] items = INI.INIGetAllItems(file, "Menu");

        ////获取指定节点中所有的键key
        //string[] keys = INI.INIGetAllItemKeys(file, "Menu");

        ////获取指定KEY的值
        //string value = INI.INIGetStringValue(file, "Desktop", "color", null);
    }
}
